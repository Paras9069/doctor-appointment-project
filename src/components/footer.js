        ...
        <div class="row">
            ...
            <div class="footer-column col-lg-6 col-md-6">
                <div class="footer-widget logo-widget">
                    <div class="logo">
                        <a href=""><img src="images/image.png" width="170px" height="300px"  /></a>
                    </div>
                    ...
                    <ul class="list-style-two">
                        <li><a href="contact.html#map-location"><span class="icon  flaticon-map-pin-marked"></span>29 Union Square W <br></br> New York, NY 10003, USA</a></li>
                        <li><a href="tel:+1-212-243-7969"><span class="icon flaticon-phone"></span>+91</a></li>
                        <li><a href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection#ec85828a83ac89948d819c8089c28f8381"><span class="icon flaticon-mail"></span><span class="__cf_email__" data-cfemail="10797e767f507568717d607c753e737f7d">health_hub@gmail.com</span></a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="clearfix">
            ...
            <div class="pull-left">
                ...
                <p class="copyright">&copy;Health HuB. All Rights Reserved.</p>
            </div>

            <div class="pull-right">
                <ul class="social-box">
                    <li class="messanger"><a href="#"><span class="icon flaticon-messenger"></span> Health HuB</a></li>
